...
- 🗄️ Base de datos: SQLite por defecto; PostgreSQL opcional vía `DATABASE_URL`.
...
## ⌨️ Comandos: ForceSubscribe sustituido por FSub
...
## ⚙️ Comportamiento Force Subscribe
...
- ⚠️ Una sola instancia (evitar `Conflict` de Telegram); en Railway usar 1 réplica.
